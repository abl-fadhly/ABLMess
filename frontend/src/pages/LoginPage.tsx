...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-neutral-100 via-white to-primary-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <form
          ...
          className="bg-surface border border-neutral-200 rounded-2xl p-6 shadow-sm space-y-4"
        >
