        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Jabatans_JabatanId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BedName = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HotelAddress = table.Column<string>(type: "text", nullable: false),
                    From = table.Column<DateOnly>(type: "date", nullable: false),
                    To = table.Column<DateOnly>(type: "date", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelPlacements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HotelPlacements_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HotelPlacements_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelPlacements_CreatedByUserId",
                table: "HotelPlacements",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelPlacements_RequestId",
                table: "HotelPlacements",
                column: "RequestId",
                unique: true);
